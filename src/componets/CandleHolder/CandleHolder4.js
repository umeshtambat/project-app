...
<div>
  ...
  <title>Votive Dragon Tail</title>
  {/* Product Details */}
  <section className="section product-detail">
    <div className="details container">
      <div className="left image-container">
        <div className="main">
          <img src="Candle_Holder\Votive_Holder.jpg" id="zoom" alt />
        </div>
      </div>
      <div className="right">
        <span>Candle Holder</span>
        <h1>Votive Dragon Tail </h1>
        ...
        <p>
          Mold your home into an aesthetic space that flaunts modern designs. This votive holder comes with an abstract design and a base that's a perfect blend of tradition and style. It is durable and long-lasting.
          Product :3 Votive Holders
          Dimensions : Votive Holders : 33 cm x 11 cm x 11 cm
          Type: Floor
          Set Size : Single Pc
          Shape : Abstract
          Material : Glass
    ...
    <div className="product-center container">
      <div className="product-item">
        ...
        <div className="product-info">
          <a href>Eternity Vogue Glass &amp; Metal</a>
          <h4>₹3500</h4>
        </div>
        <ul className="icons">
      ...
      <div className="product-item">
        ...
        <div className="product-info">
          <a href>Pacific Salsa Lantern</a>
          <h4>₹1250</h4>
        </div>
        <ul className="icons">
          <li><i className="bx bx-heart" /></li>
