...
<div>
  ...
  <title>Pedestal Votive </title>
  {/* Product Details */}
  <section className="section product-detail">
    <div className="details container">
      <div className="left image-container">
        <div className="main">
          <img src="Candle_Holder\Pedestal_Votive_Holder.jpg" id="zoom" alt />
        </div>
      </div>
      <div className="right">
        <span>Candle Holder</span>
        <h1>Pedestal Votive </h1>
        ...
        <p>
          Mold your home into an aesthetic space that flaunts modern designs. This votive holder has an abstract design and an iron stand that perfectly blends tradition and style. It is durable and long-lasting.
          Product :  1 Votive Holder
          Dimensions :  Votive Holder: 11.5 x 11.5 cm
          Type : Table Top
          Set Size : Single Pc
          Shape : Abstract
          Material :  Glass
    ...
    <div className="product-center container">
      <div className="product-item">
        ...
        <div className="product-info">
          <a href>Pacific Salsa Labntern</a>
          <h4>₹1250</h4>
        </div>
        <ul className="icons">
      ...
      <div className="product-item">
        ...
        <div className="product-info">
          <a href>Mossaic Tappered Hurricane</a>
          <h4>₹7000</h4>
        </div>
        <ul className="icons">
          <li><i className="bx bx-heart" /></li>
      ...
      <div className="product-item">
        ...
        <div className="product-info">
          <a href>See-Saw Golden Candle Holder</a>
          <h4>₹2500</h4>
        </div>
        <ul className="icons">
          <li><i className="bx bx-heart" /></li>
