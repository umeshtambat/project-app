...
<div>
  ...
  <title>Corsica Silver Metal Leaf Plate </title>
  {/* Product Details */}
  <section className="section product-detail">
    <div className="details container">
      <div className="left image-container">
        <div className="main">
          <img src="Table_Accent\Corsica_Zarin_metal_Leaf_Platter.jpg" id="zoom" alt />
        </div>
      </div>
      <div className="right">
        <span>Table Accents</span>
        <h1>Corsica Zarin Metal Silver Leaf Platter</h1>
        ...
        <p>
          You can use them anywhere in a room to create a charming spot or use them as a centerpiece. sleek, modern finish and very sturdy. Go green and enhance the beauty of your study table or office desk. It's the best eco-friendly gift for your loved ones.
  ...
  <section className="section featured">
    ...
    <div className="product-center container">
      ...
      <div className="product-item">
        <div className="overlay">
          <a href="BlackMetalicGlobeInfo.html" className="product-thumb">
            <img src="Table_Accent\Corsica_Cronus_Metal_Globe.jpg" alt />
          </a>
          {/* <span class="discount">40%</span> */}
        </div>
        <div className="product-info">
          <a href>Corsica Cronus Metal Globe</a>
          <h4>₹899</h4>
        </div>
        <ul className="icons">
          <li><i className="bx bx-heart" /></li>
