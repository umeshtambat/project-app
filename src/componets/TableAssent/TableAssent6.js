...
<div>
  ...
  <title>Moksha Gold Vessel </title>
  {/* Product Details */}
  <section className="section product-detail">
    <div className="details container">
      <div className="left image-container">
        <div className="main">
          <img src="Table_Accent\MokshaGoldVessel2.jpg" id="zoom" alt />
        </div>
      </div>
      <div className="right">
        <span>Table Accents</span>
        <h1>Moksha Gold Glass Vessel</h1>
        ...
        <p>
          An ideal pick to extravagant your area, this canister is made with sturdy material and a compact design. Featuring an excellent finish, the airtight lid allows the content to stay fresh and moist.
          Product : 1 Canister
          Dimensions : Canister : 11x11x28.5cm
          Set Size : Single Pc
          Shape : Round
          Material : Glass
          Design : Textured
          Care Instructions : Clean with soft dry cloth
          Collection : Moksha Decor
          Net Quantity : 1 N
