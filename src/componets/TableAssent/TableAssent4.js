...
<div>
  ...
  <title>Ceramic Bird Canister</title>
  {/* Product Details */}
  <section className="section product-detail">
    <div className="details container">
      <div className="left image-container">
        <div className="main">
          <img src="Table_Accent\BirdCanister.jpg" id="zoom" alt />
        </div>
      </div>
      <div className="right">
        <span>Table Accents</span>
        <h1>Ceramic Bird Decorative Canister</h1>
        ...
        <p>
          Lend a finishing touch to your space with this decorative canister. Made from ceramic, it features an elegant design with floral detailing and a bird accent on the lid.
          Product : 1 Decorative Platter
          Dimensions : Canister With Lid: 12x10x10cm
          Set Size : Single Pc
          Shape : Round
          Material : Ceramic
          Design : Solid
