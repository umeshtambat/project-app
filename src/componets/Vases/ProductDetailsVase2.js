        ...
        <section className="section product-detail">
          <div className="details container">
            <div className="left image-container">
              <div className="main">
                <img src="./images/v2.png" id="zoom" alt />
              </div>
            </div>
            <div className="right">
              <span>Home/Vases</span>
              <h1>Thick Black Malena Glass Flower Vase, By Tayhaa</h1>
              <div className="price">₹1,609</div>
              <form className="form">
              ...
              <p>
                Brand Tayhaa Assembly No Assembly Required Colour Grey
                Dimensions (In Centimeters) L 10.9 x B 10.9 x H 14.5 Dimensions
                (In Inches) L 4.3 x B 4.3 x H 5.7 Material Glass Pack Content 1
                Vase Weight 0.5 Kg Sku DE2045075-S-PM9076
              </p>
            </div>
          </div>
        </section>
...
export default ProductDetailsVase2;
