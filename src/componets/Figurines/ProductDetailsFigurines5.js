function ProductDetailsFigurines5() {
  return (
    <>
      <div>
        <meta charSet="UTF-8" />
        ...
        <section className="section product-detail">
          <div className="details container">
            <div className="left image-container">
              <div className="main">
                <img src="./images/fig5.png" id="zoom" alt />
              </div>
            </div>
            <div className="right">
              <span>Home/Figurines</span>
              <h1>Brighton Ceramic Fox Figurine</h1>
              ...
              <p>
                et an aesthetic upgrade to your home with this decorative fox
                figurine. It is made with a textured surface and a sturdy
                material like ceramic. This enchanting figurine adds a dash of
                class to your home and is a perfect gifting solution. Product :
                1 Figurine Dimensions : Figurine : 13 cm x 10 cm x 21 cm
                Material : Ceramic Set Size : Single Pc Design : Textured Care
                Instructions : Wipe with a damp cloth. Collection : Brighton
                Ideal For : Living Room Manufactured By : - Net Quantity : 1 N
                For Consumer Complaints Contact : Name: Syed Ismail, Email:
                help@homecentre.in, Lifestyle International Pvt Ltd,
                1800-212-7500 Country of Origin : China Manufacture and Marketed
...
export default ProductDetailsFigurines5;
