  ...
  <section className="section product-detail">
    <div className="details container">
      <div className="left image-container">
        <div className="main">
          <img src="./photo frames/frame9.jpg" id="zoom" alt />
        </div>
      </div>
      <div className="right">
        <span>Home/Photo Frames </span>
        <h1>Artistry Wooden Photo Frame</h1>
        <div className="price">₹1,599</div>
        <form className="form">
...
export default ProductDetailsFrame7;